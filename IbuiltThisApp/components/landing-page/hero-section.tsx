...
const LiveBadge = () => {
  return (
    ...
    >
      {/* Animated ping effect to indicate live status */}
...
const statsData = [
  { label: "Projects Shared", value: "2.5K+", icon: RocketIcon },
  { label: "Active Creators", value: "10K+", icon: UsersIcon, hasBorder: true },
  { label: "Monthly Visitors", value: "50K+", icon: EyeIcon },
];
